...
import '../../../../models/tool_model.dart';
import '../tools/tools_section.dart';
import 'package:syncfusion_flutter_pdfviewer/pdfviewer.dart'; // Add the syncfusion pdf viewer import
...
class _HomeViewState extends State<HomeView> {
  ...
  // Fix: Replace commented code with actual SfPdfViewer for PDF display
  void _openPDF(BuildContext context, String path) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: SfPdfViewer.file(File(path)), // Display the PDF
                ),
              ],
            ),
          ),
              ...
              child: Row(
                children: [
                  ...
                  PopupMenuButton(
                    ...
                    itemBuilder: (context) => [
                      PopupMenuItem(
                          child: CustomText(text: "Open", fontSize: 13,), value: "open"),
                      PopupMenuItem(
                          child: CustomText(text: "Delete", fontSize: 13), value: "delete"),
                    ],
                    icon: Icon(Icons.more_vert, color: Colors.grey),
                  ),
                ],
